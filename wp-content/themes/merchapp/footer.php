	...
	<section class="container ft " background-color: #e7e7e7; display: flexbox;">
		...
		<div class="ft-col container">
			...
			<ul class="contacts col-space">
				<li><a href="#" aria-label="about">Company</a></li>
				<li><a href="#" aria-label="s">Ecommerce Automation</a></li>
				<li><a href="#" aria-label="s">Services</a></li>
			...
			<ul >
				<li>
					<div class="contacts ft-contacts " style="justify-content:flex-start;">
						...
						<a class="map-address" href="https://www.google.com/maps/place/In1Go+Technologies+Inc./@14.4481538,120.9922245,17z/data=!4m12!1m6!3m5!1s0x3397cf04d69589b7:0x378e5251d103adb7!2sLAS+PINAS+CARGO+COMPLEX!8m2!3d14.4481486!4d120.9944132!3m4!1s0x0:0x4b64607b8f930152!8m2!3d14.447798!4d120.9948852" id="address" aria-label="address" target="_blank">
				...
				<li>
					<div class="contacts ft-contacts" style="display:block">
						<a href="tel:+63288143209" aria-label="phone" style="margin-top:.5rem;"> <i class="fa fa-phone social-icons"
							...
							<br>
							<a class="number-left" href="tel:+63285118618" id="number2" aria-label="contact number2">+63 2 8511 8618</a>
					</div>
					<div class="contacts ft-contacts" style="justify-content:flex-start;">
						<a href="mailto:customercare@in1go.com.ph" aria-label="email address" id="email"> <i class="fa fa-envelope social-icons"
								style="border-radius: 20px; padding: .7em; "></i></a>
						<a href="mailto:customercare@in1go.com.ph" id="email" style="margin-left:2%">customercare@in1go.com.ph</a>
					</div>
				</li>
				<li>
					<div class="contacts ft-contacts solicons solicon">
						...
						<a href="https://www.linkedin.com/company/in1gotech" target="_blank" aria-label="linkedin profile">
