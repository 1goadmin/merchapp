...
<header class="container-fluid nav-container" style= "z-index:2; width:100vw; margin-left: 0; margin-right: 0;">
		<nav class="container navigation">
			<ul class="menunav" style="margin-left:.02rem;">
				<li class="logo" style="text-align:left;"><a style="margin-right:50%;" href="<?=bloginfo('url');?>/"><img class="invlogo" src="https://1goadmin.github.io/merchapp/img/malogoinv.svg" alt="logo" ></a></li>
